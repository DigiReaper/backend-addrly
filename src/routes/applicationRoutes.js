...
router.post(
	"/add-to-waitlist",
	asyncHandler(applicationController.addApplicantToWaitlist)
);

// get all waitlist entries
router.get(
	"/waitlist",
	asyncHandler(applicationController.getAllWaitlistEntries)
);
...
router.post("/analyze-match", asyncHandler(applicationController.analyzeMatch));
